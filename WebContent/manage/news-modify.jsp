...
<title>后台管理 - 买道-商城</title>
<link type="text/css" rel="stylesheet" href="../css/style.css" />
<script type="text/javascript" src="../scripts/function-manage.js"></script>
</head>
<body>
<div id="header" class="wrap">
	<div id="logo"><a href="index.jsp"><img height="50px"width="100px"src="../images/maidao.png "/></a></div>
...
<div id="position" class="wrap">
	您现在的位置：<a href="index.jsp">买道-商城</a> &gt; 管理后台
</div>
...
<div id="footer">
	Copyright &copy; 2021 买道 All Rights Reserved.
</div>
</body>
</html>
